  ...
  return (
    <div className="vv-world min-h-screen flex items-center justify-center px-6" role="status" aria-live="polite">
      <div className="vv-panel text-center max-w-md w-full">
        <div className="text-xs uppercase tracking-[0.2em] text-gray-400">VentoVault</div>
        <div className="mt-2 text-lg font-semibold text-gray-900 font-display">Loading...</div>
